...
M569 P1 S0							; Reverse Y motor?
M558 P0                             ; Use a modulated Z probe (P1) - P0 is a switch
;M556 S78 X0 Y0 Z0                  ; Put your axis compensation here

M201 X1000 Z15 E300  	          	; Accelerations (mm/s^2)
M203 X2000 Y1500 Z500 E1000       	; Maximum speeds (mm/min)
M566 X500 Y500 Z100 E200            ; Minimum speeds mm/minute. Note, not really min speed, but min cornering speed?

M92 X530                            ; Set x steps per mm
...
;G10 P0 S110 R0
G10 P0 X0 Y0 Z0 S-273 R-273 		; Set tool 0 operating and standby temperatures
G10 P1 X-100 Y0 Z0 S0 R0 			; Set tool 1 operating and standby temperatures
...
M92 E632.72							; Set extruder steps/mm
M906 .E400 							; Motor current (mA)
...
T0 									; Select extruder 0 again as main extruder

;M201 X800 Y800 Z15 E1000            ; Accelerations (mm/s^2)
;M203 X15000 Y15000 Z100 E3600       ; Maximum speeds (mm/min)
;M566 X600 Y600 Z30 E20              ; Minimum speeds mm/minute

M206 X240 Y90 Z60					 ;set maximum reach, with virtual endstops on, it will not go past these maxima. 
